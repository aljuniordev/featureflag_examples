package com.example.featureflag.add_strategy_patterns_in_change_status_example.infra.adapter.out.oracle;

import com.example.featureflag.add_strategy_patterns_in_change_status_example.infra.adapter.out.oracle.entity.WoEntity;
import com.example.featureflag.add_strategy_patterns_in_change_status_example.infra.adapter.out.oracle.implementation.JpaOracleRepositoryImpl;
import com.example.featureflag.add_strategy_patterns_in_change_status_example.infra.adapter.out.oracle.mapper.WoEntityToDomain;
import com.example.featureflag.add_strategy_patterns_in_change_status_example.domain.Wo;
import com.example.featureflag.add_strategy_patterns_in_change_status_example.application.port.out.WoRepositoryB2cPortOut;
