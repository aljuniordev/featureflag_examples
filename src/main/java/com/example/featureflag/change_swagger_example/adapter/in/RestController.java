package com.example.featureflag.change_swagger_example.adapter.in;

import com.example.featureflag.change_swagger_example.adapter.in.dto.WoSwagger;
import com.example.featureflag.change_swagger_example.adapter.in.dto.WoSwaggerFTFPTIXXX1;
import com.example.featureflag.change_swagger_example.adapter.in.mapper.WoDomainToSwagger;
import com.example.featureflag.change_swagger_example.adapter.in.mapper.WoDomainToSwaggerFtfFenix;
import com.example.featureflag.change_swagger_example.adapter.out.feature_flag.FeatureFlagAdapterOut;
import com.example.featureflag.change_swagger_example.adapter.out.oracle.WoRepositoryB2c;
import com.example.featureflag.change_swagger_example.domain.Wo;
import com.example.featureflag.change_swagger_example.port.in.CreateWoUseCaseV1;
import com.example.featureflag.change_swagger_example.port.in.CreateWoUseCaseV2;
